...
test('Preserves import parameters', () => {
  ...
  expect(pp.process("//@magento_import (reference) 'source/_module.less';")).toEqual(
    "@import (optional, reference) '../Magento_Catalog/css/source/_module.less';"
  )

  expect(pp.process("//@magento_import (optional) 'source/_module.less';")).toEqual(
    "@import (optional) '../Magento_Catalog/css/source/_module.less';"
  )

  expect(pp.process("//@magento_import (multiple, less, inline) 'source/_module.less';")).toEqual(
